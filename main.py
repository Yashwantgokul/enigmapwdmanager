...
while True:
    while True:
        ...
        if ch == 2:
                                    ...
                                    if ques == "y":
                                        ...
                                        while True:
                                            if confirm.lower()=="y":
                                                ...
                                                print("You would be able to see this account for the next five minutes")
                                                confirm = input("Do you want to recover your account(y/n): ")
                        ...
                        if umail[ind] == uinmail:
                            ...
                            if is_logged_in:  # Use the stored result to check if login was successful
                                while True:
                                    c = 0
                                    while True:
                                        newpas = input("Your New MasterKey Password(should have a minimum of 8 characters and maximum of 16 characters): ")
                                        if len(newpas) > 7 and len(newpas) < 17:
                                            break
                                        if c == 5:
                                            print("Retype your Details and login")
                                            exit()
                                        else:
                                            print("Incorrect entry!")
                                            c += 1
                                    ...
                                    if newpas != "forgotpwd":
                                        if newpas not in comp:
                                            if stpf == True:
                                                newpasc = input(
                                                    "Retype Your New MasterKey Password(should have a minimum of 8 characters and maximum of 16 characters): ").strip()
                                                if newpas == newpasc:
            ...
            if plen < 8:
                print("Minimum Length is 8 only")
                plen=8
            elif plen > 16:
                print("Maximum Length is 16 only")
                plen=16
            p = pgen(plen)
